...
public sealed class ExecuteSqlCommandStepCruder : StepCruder<ExecuteSqlCommandStep>
{
    public ExecuteSqlCommandStepCruder(ILogger logger, IHttpClientFactory httpClientFactory, Processes processes,
        ParametersManager parametersManager, Dictionary<string, ExecuteSqlCommandStep> currentValuesDictionary) : base(
        logger, httpClientFactory, processes, parametersManager, currentValuesDictionary, "Execute SQL Command Step",

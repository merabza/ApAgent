...
public sealed class FileBackupFolderCruder : ParCruder
{
    ...
    public FileBackupFolderCruder(Dictionary<string, string> currentValuesDict, IParametersManager parametersManager,
        object record, BackupFolderPathsFieldEditor backupFolderPathsFieldEditor) : base(parametersManager,
        "Backup Folder Path", "Backup Folder Paths")
    {
